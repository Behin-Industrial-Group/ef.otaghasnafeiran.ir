<form action="javascript:void(0)" id="modal_form">
    ...
    <div class="form-group col-sm-4">
        ...
        <input type="text" name="excutive_director_fullname" value="{{ $data['excutive_director_fullname'] ?? '' }}" class="form-control" id="exampleInputPassword1"
            placeholder="{{ __('executive director fullname') }}">
    </div>
    <div class="form-group col-sm-4">
        <label for="exampleInputPassword1">{{ __('executive director mobile') }}:</label>
        <input type="text" name="excutive_director_mobile" value="{{ $data['excutive_director_mobile'] ?? '' }}" class="form-control" id="exampleInputPassword1"
