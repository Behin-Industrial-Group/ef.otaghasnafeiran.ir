...
<body>
    <div class="main">
        <div class="container a-container" id="a-container">
            <form class="form" action="javascript:void(0)" method="post" id="send-code-form">
        ...
        <p>ریاست محترم اتاق اصناف لطفا جهت ورود شماره موبایل خود را وارد کنید</p>
                ...
                <div class="form__icons">
                    ...
                    @csrf
                    <input type="number" class="form__input" name="mobile" id="mobile" placeholder="{{__('mobile')}}" autocomplete="off">
                    <button onclick="send_code()" class="form__button button submit">{{__('Send code')}}</button>
        
                
            </form>
            <form class="form" action="javascript:void(0)" method="post" id="login-form" style="display: none">
                @csrf
